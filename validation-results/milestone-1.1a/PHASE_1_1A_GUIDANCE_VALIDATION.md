...
Generated: 2026-09-02T15:24:23.111140+00:00
...
- Non-null classifications among comparable names: 11
- Comparable-guidance coverage: 84.6%
...
| --- | ---: | ---: | ---: | --- | --- | --- | ---: |
| ADBE | 30 | 1 | 0 | NOT_DETERIORATED | False | guidance_v1_1.comparable_set_within_tolerance | 0 |
...
| AVGO | 33 | 0 | 0 | UNKNOWN | None | guidance_v1_1.no_comparable_prior | 0 |
...
| ABT | 23 | 2 | 0 | UNKNOWN | None | guidance_v1_1.conflicting_primary_evidence | 0 |
...
```json
{
  "All verified comparable current quantitative guidance metrics remain within frozen non-deterioration tolerances or are higher.": 8,
  "At least one current quantitative non-initiated guidance metric lacks a verified comparable prior record.": 3,
  ...
  "No comparable prior/current quantitative guidance metric pair is available.": 27,
