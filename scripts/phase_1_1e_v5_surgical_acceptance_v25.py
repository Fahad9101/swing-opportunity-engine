...
def test_document_annual_heading_recovers_late_current_prior_fcf_pair_v25():
...
def test_intervening_quarter_heading_blocks_annual_prior_pair_recovery_v25():
    ex = extract_canonical_typed_guidance_facts(_doc(
        "CLSV25NEG",
        "2025 Annual Outlook Update\n"
        "Revenue outlook of $11.55 billion (previous outlook $10.85 billion)\n"
