...
from app.providers.yahoo_analyst import YahooAnalystEstimateProvider, normalize_yahoo_earnings_trend
...
def test_yahoo_provider_bootstraps_crumb_and_caches_response(tmp_path):
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        if request.url.path == "/v10/finance/quoteSummary/TEST":
            counts["quote"] += 1
            assert request.url.params.get("modules") == "earningsTrend"
