...
_GUIDANCE_PATTERNS = [
    ...
    # "as we close fiscal year 2025. Financial Outlook ... provides guidance"
    # can bridge into a following quarterly-only guidance section.
    re.compile(
        rf"\b{_ANNUAL_PERIOD}\b[^.!?]{{0,48}}\b{_GUIDANCE_TERM}\b[^.!?]{{0,140}}\b{_GUIDANCE_ACTION}\b",
        re.I | re.S,
    ),
